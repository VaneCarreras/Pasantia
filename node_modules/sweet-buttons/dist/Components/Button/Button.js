...
const Button = forwardRef(({ ariaLabel, shape, size, variant, colorscheme, className, onClick, _isDisabled, ...props }, ref) => {
    return (React.createElement("button", { ref: ref, className: cn(buttonStyles({ shape, size, variant, colorscheme, className })), onClick: onClick, disabled: _isDisabled, "aria-label": ariaLabel, ...props }));
});
